...
--SET email = CONCAT(LOWER(SELECT surname FROM bankdemo.accounts WHERE phone='0000000000'), '@greenmail.io') WHERE phone='0000000000';
--UPDATE bankdemo.accounts 
--SET email = CONCAT(LOWER(SELECT surname FROM bankdemo.accounts WHERE phone='1111111111'), '@greenmail.io') WHERE phone='1111111111';
--UPDATE bankdemo.accounts 
--SET email = CONCAT(LOWER(SELECT surname FROM bankdemo.accounts WHERE phone='2222222222'), '@greenmail.io') WHERE phone='2222222222';
--UPDATE bankdemo.accounts 
--SET email = CONCAT(LOWER(SELECT surname FROM bankdemo.accounts WHERE phone='3333333333'), '@greenmail.io') WHERE phone='3333333333';
