INSERT INTO bankdemo.accounts(id, active, birthday, name, password, phone, surname, created_at)
VALUES('0', '1', '1900-01-01', 'Admin', crypt('superadmin', gen_salt('bf', 4)), '0000000000', 'Adminsky', now());
INSERT INTO bankdemo.accounts(active, birthday, name, password, phone, surname, created_at)
VALUES('1', '2022-05-09', 'Ursula', crypt('supervixen', gen_salt('bf', 4)), '1111111111', 'Digard', now()),
('1', '2022-05-09', 'Marsha', crypt('bustyblonde', gen_salt('bf', 4)), '2222222222', 'Jordan', now()),
('1', '2022-05-09', 'Lenina', crypt('gingerchick', gen_salt('bf', 4)), '3333333333', 'Crowne', now())
