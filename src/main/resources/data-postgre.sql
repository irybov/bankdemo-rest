...
('1', '2022-05-09', 'Marsha', crypt('bisexblonde', gen_salt('bf', 4)), '2222222222', 'Jordan', now()),
('1', '2022-05-09', 'Darla', crypt('redhotchick', gen_salt('bf', 4)), '3333333333', 'Crane', now()),
('1', '2022-05-09', 'Maggie', crypt('plumpwhore', gen_salt('bf', 4)), '4444444444', 'Green', now())
